...
<div class="singleview_container">
			<div class="logo singleview">
                <a href="https://kristinekofoedd.dk/kea/2_semester/tema_10/wordpress/" class="logo_desktop"><img src= "<?php echo get_stylesheet_directory_uri() ?>/assets/bogino_logo_v2.svg" alt=""></a>
                <a href="https://kristinekofoedd.dk/kea/2_semester/tema_10/wordpress/" class="logo_mobile"><img src= "<?php echo get_stylesheet_directory_uri() ?>/assets/bogino_logo_mobile.svg" alt=""></a>
            </div>
		...
		<script>
			/** @format */
			const url = "https://kristinekofoedd.dk/kea/2_semester/tema_10/wordpress/wp-json/wp/v2/produkt/" + <?php echo get_the_ID() ?>;
			const colourUrl = "https://kristinekofoedd.dk/kea/2_semester/tema_10/wordpress/wp-json/wp/v2/produkt/" + <?php echo get_the_ID() ?>;
